...
export const handleInsertarCarrera = async (data) => {
  try {
    ...
    await axios.post(
      ...
      "http://192.168.1.12:3001/api/v1/carrera/addcarrera",
      data
    );
...
export const handleEditarCarrera = async (carreraData, facultadId) => {
  try {
    ...
    await axios.put(
      "http://192.168.1.12:3001/api/v1/carrera/updatecarrera/" + facultadId,
      carreraData
    );
...
export const handleEliminarCarrera = async (carreraId) => { 
  try {
    await axios.delete(
      "http://192.168.1.12:3001/api/v1/carrera/deletecarrera/" + carreraId );
