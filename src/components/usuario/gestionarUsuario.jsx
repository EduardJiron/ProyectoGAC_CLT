...
import FormEliminarUsuario from "./FormEliminarUsuario";
...
export const GestionarUsuario = ({ uri }) => {
    ...
    const handleRecargarDatos = async () => {
        try {
            ...
            console.log(config);
            const responseUsuarioes = await axios.get(uri, config);
            setData(responseUsuarioes.data.body);
        } catch (error) {
